...
import UserAuthLogin from '#components';

describe(`UserAuthLogin Component`, () => {
  test(`rend le formulaire avec les champs requis`, async () => {
    const wrapper = await mountSuspended(UserAuthLogin);
    expect(wrapper.text()).toMatchInlineSnapshot(`"hello"`);
